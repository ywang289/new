...
let type = document.querySelector('.achieve_title').value;
let description = document.querySelector('.achieve_description').value;
...
function toggleSections() {
    var this_choice = document.getElementById('typeSection').value;
    choice= this_choice;
    if(this_choice === 'bga') {
        document.getElementById('aboutSection').style.display = 'block';
        document.getElementById('achievementsSection').style.display = 'none';
    } else if(this_choice === 'non-bga') {
...
const displayCV = (userData) => {
    if (choice==='bga'){ timeDsp.innerHTML= "the creating day is" + userData.timer;
  ...
  `;}else if (choice === 'non-bga'){
    timeDsp.innerHTML= "the creating day is" + timer;
    ballDsp.innerHTML ="the type is: "+ type  + " the description is " + description;
...
function test_type() {
    ...
    if (selection === 'hirox') {
      ...
      if (singlePhotoResult) {
        fileToBase64(singlePhotoResult, function(answer) {
            console.log(answer); // 这是你的Base64编码的图像
            base64Image = answer;
        });
    }
...
function test_type2() {
    let selection = document.getElementById('typeSection3').value;
    testResultType = selection; // Update testResultType with the current selection

    let photoInput = document.getElementById('photoInput2');
    let numberInput = document.getElementById('numberInput2');
    let zipInput = document.getElementById('zipInput2');
    ...
    if (selection === 'hirox') {
      ...
      singlePhotoResult = document.getElementById('singlePhotoResult2').files[0];
      if (singlePhotoResult) {
        fileToBase64(singlePhotoResult, function(answer) {
            console.log(answer); // 这是你的Base64编码的图像
            base64Image = answer;
      ...
      if (singlePhotoResult) {
        ...
        photoInput2.style.display = 'none';
        numberInput2.style.display = 'block';
        zipInput2.style.display = 'none';
        console.log("this is in ");
        let shear_Result= document.getElementById('numberResult2');
        if (!shear_Result) {
        ...
        zipInput2.style.display = 'none';
        console.log("this is the new");
        let drop_Result=  document.getElementById('numberResult2');
        console.log(drop_Result);
        if (!drop_Result) {
          dropResult= 0;  // default to 0 if not found
        }else{
        ...
        zipInput2.style.display = 'block';
        zipResult = document.getElementById('zipResult2').files[0];
    }
