...
let firstnameElem = mainForm.board_type,
    middlenameElem = mainForm.ball_size,
    lastnameElem = mainForm.displayTable,
    imageElem = mainForm.paste_type,
    designationElem = mainForm.paste_size,
    addressElem = mainForm.displayTable2,
    emailElem = mainForm.edu_start_date,
    phonenoElem = mainForm.reflow_temp,
    summaryElem = mainForm.reflow_time;
...
const getUserInputs = () => {
    ...
    firstnameElem.addEventListener('keyup', (e) => validateFormData(e.target, validType.TEXT, 'board_type'));
